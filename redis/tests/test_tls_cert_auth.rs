...
impl CertAuthTestContext {
    ...
    fn get_version(&self) -> support::Version {
        self.server_ctx.get_version()
    }
}
...
fn test_tls_certificate_authentication_with_matching_acl_user() {
    ...
    // Skip if Redis version is below 8.6
    ...
    // User can: GET, SET, PING, ACL WHOAMI
    // User cannot: DEL, FLUSHDB, etc.
    ...
    // Now connect using the client certificate with CN=test_username

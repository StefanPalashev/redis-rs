...
mod basic {
    ...
    use redis::{
        ...
        ScanOptions, Value, ValueType, VectorAddInput, VectorSimilaritySearchInput,
    };
    use redis::{
        ...
        RedisResult, SetExpiry, SetOptions, ToRedisArgs, TypedCommands, VAddOptions, VSimOptions,
        VectorQuantization,
    };
